...
const menuItems = [
  ...
  { id: 3, label: "Portoflio", href: "#portofolio" },
...
>
  <img
    src="/logo.png" 
    alt="Yoga Imam Logo"
    className="h-8 md:h-10 object-contain drop-shadow-[0_0_8px_rgba(6,182,212,0.6)] transition-transform duration-300 hover:scale-105"
  />
</a>
